    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function dateCtrlInit() {
                ...
                if (/^\d{4}-\d{1,2}-\d{1,2}$/.test(_self.trigger.textContent)) {
                    rs = _self.trigger.textContent.match(/(^|-)\d{1,4}/g);
            ...
            function ymCtrlInit() {
                ...
                if (/^\d{4}-\d{1,2}$/.test(_self.trigger.textContent)) {
                    rs = _self.trigger.textContent.match(/(^|-)\d{1,4}/g);
                    dateArr.yy = rs[0] - _self.minY;
                    dateArr.mm = rs[1].replace(/-/g, "") - 1;
                } else {
            ...
            function dateTimeCtrlInit() {
                ...
                if (/^\d{4}-\d{1,2}-\d{1,2}\s\d{2}:\d{2}$/.test(_self.trigger.textContent)) {
                    rs = _self.trigger.textContent.match(/(^|-|\s|:)\d{1,4}/g);
                    dateArr.yy = rs[0] - _self.minY;
                    dateArr.mm = rs[1].replace(/-/g, "") - 1;
                    dateArr.dd = rs[2].replace(/-/g, "") - 1;
            ...
            function timeCtrlInit() {
                ...
                if (/^\d{2}:\d{2}$/.test(_self.trigger.textContent)) {
                    rs = _self.trigger.textContent.match(/(^|:)\d{2}/g);
            ...
            function finishMobileDate(e) {
                ...
                _self.trigger.textContent = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd;
                _self.value = _self.trigger.textContent;
            ...
            function finishMobileYM(e) {
                ...
                var date_mm = parseInt(Math.round(_self.gearDate.querySelector(".date_mm").getAttribute("val"))) + 1;
                date_mm = date_mm > 9 ? date_mm : '0' + date_mm;
                _self.trigger.textContent = (date_yy % passY + _self.minY) + "-" + date_mm;
                _self.value = _self.trigger.textContent;
                if(_self.onSubmit) _self.onSubmit();
                closeMobileCalendar(e);
            }
            ...
            function finishMobileDateTime(e) {
                ...
                _self.trigger.textContent = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd + " " + (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") + time_mm;
                _self.value = _self.trigger.textContent;
                if(_self.onSubmit) _self.onSubmit();
                closeMobileCalendar(e);
            }
            ...
            function finishMobileTime(e) {
                ...
                var time_mm = parseInt(Math.round(_self.gearDate.querySelector(".time_mm").getAttribute("val")));
                time_mm = time_mm > 9 ? time_mm : '0' + time_mm;
                _self.trigger.textContent = (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") + time_mm;
                _self.value = _self.trigger.textContent;
                if(_self.onSubmit) _self.onSubmit();
                closeMobileCalendar(e);
            }
